...
api_id = int(os.environ.get("APP_ID", "26676259"))
api_hash = os.environ.get("API_HASH", "a6194f7e8ec4adf87e5a50c7e9335f5c")
bot_token = os.environ.get("TOKEN", "5799143538:AAEA2JWzuRzum3n1JqTut_zsGMboQOIXdZk")
...
async def start(event):
    ...
    await event.reply(
        "━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ɪ ᴀᴍ ᴜᴍɪᴋᴏ ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴛʜᴇ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ɪɴ ᴛᴇʟᴇɢʀᴀᴍ\n✪ ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ ʀᴜɴ /help..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ    : [ᴢᴏɴᴇʏ ᴏᴘ](https://t.me/itszoney)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [ᴜᴍɪᴋᴏ ʜᴇʟᴘ](https://t.me/INDIAN_SINGING_GROUPP)┓\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/itszoney) ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━",
        link_preview=False,
        buttons=(
            [
                Button.url(
                    "☀︎︎️ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ☀︎︎",
                    "https://t.me/UMIKO_CHAT_BOT?startgroup=true",
                ),
            ],
            [
                Button.url("☀︎︎ ɢʀᴏᴜᴘ ☀︎︎︎", "https://t.me/INDIAN_SINGING_GROUPP"),
                Button.url("☀︎︎ ᴄʜᴀɴɴᴇʟ ☀︎︎", "https://t.me/IND_BRAND"),
            ],
            [
                Button.url("☀︎︎ ʙʀᴏ ☀︎︎️️", "https://t.me/IND_CHIRAG"),
                Button.url("☀︎︎ ᴋɪɴɢ ☀︎︎︎", "https://t.me/itszoney"),
            ],
        ),
    )
...
async def help(event):
    ...
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ ᴜᴍɪᴋᴏ ᴍᴇɴᴛɪᴏɴ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [ᴢᴏɴᴇʏ ᴏᴘ](https://t.me/itszoney)  🖤."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
            [
                Button.url("☀︎︎ ʜᴇᴀʀᴛ", "https://t.me/IND_BRAND"),
                Button.url("ᴄʜᴀᴛᴛɪɴɢ ɢʀᴏᴜᴘ ☀︎︎", "https://t.me/INDIAN_SINGING_GROUPP"),
            ]
        ),
    )
